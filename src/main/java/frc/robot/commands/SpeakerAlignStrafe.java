...
public class SpeakerAlignStrafe extends ProfiledPIDCommand {
    ...
    public SpeakerAlignStrafe(CommandSwerveDrivetrain drivetrain, DoubleSupplier xSpeed, DoubleSupplier ySpeed) {
        super(
    ...
    public void initialize() {
        ...
        SpeakerAlignStrafe.target = angle;
    }
