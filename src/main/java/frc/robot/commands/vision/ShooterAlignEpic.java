...
public class ShooterAlignEpic extends ProfiledPIDCommand {
    ...
    public ShooterAlignEpic(CommandSwerveDrivetrain drivetrain, ShootingStrategy strategy) {
        super(
    ...
    public void initialize() {
        ...
        ShooterAlignEpic.target = drivetrain.getState().Pose.getRotation().plus(strategy.getTargetOffset());
    }
