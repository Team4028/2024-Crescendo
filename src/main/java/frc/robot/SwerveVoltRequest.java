...
public class SwerveVoltRequest implements SwerveRequest {
    private final MotionMagicVoltage m_motionMagicCtrl = new MotionMagicVoltage(0, false, 0, 0, false, false, false);
    private final VoltageOut m_voltOutCtrl = new VoltageOut(0.);
