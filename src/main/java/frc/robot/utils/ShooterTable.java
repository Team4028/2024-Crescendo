...
public class ShooterTable {
    ...
    private static void fillInTable() {
        ...
        table.add(new ShooterTableEntry(Feet.of(4.2), 4.34, 21.588, 0.97, 4.5, 30.9, 0.6)); // 55 degrees
        ...
        table.add(new ShooterTableEntry(Feet.of(10.1), 9.17, -6.465, 0.257, 1.195, 12.1, 1.0)); // 31 degrees
        ...
        table.add(new ShooterTableEntry(Feet.of(16.75), 13.115, -15.395, 0.114, 0.528, 4.3, 1.0)); // 23 degrees
