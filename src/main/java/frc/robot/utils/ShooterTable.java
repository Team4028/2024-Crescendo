...
public class ShooterTable {
    ...
    private static void fillInTable() { // TODO: fill in photonStationaryDistance values
        ...
        shooterTable.add(new ShooterTableEntry(Feet.of(4.4), 30.9 + 0.75, 0.6, Feet.of(0.0))); // 55 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(5), 28.0 + 0.75, 0.7, Feet.of(0.0))); // 50 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(6), 23.8 + 0.75, 0.8, Feet.of(0.0))); // 45 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(8), 17.0 + 0.75, 0.9, Feet.of(0.0))); // 36 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(10), 13.1 + 0.75, 1.0, Feet.of(0.0))); // 31 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(11.5), 10.2 + 0.75, 1.0, Feet.of(0.0)));
        shooterTable.add(new ShooterTableEntry(Feet.of(13), 7.7 + 0.75, 1.0, Feet.of(0.0))); // 25 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(14.5), 6.5 + 0.75, 1.0, Feet.of(0.0)));
        shooterTable.add(new ShooterTableEntry(Feet.of(16), 5.1 + 0.75, 1.0, Feet.of(0.0))); // 23 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(17.5), 4.9 + 0.75, 1.0, Feet.of(0.0)));
        shooterTable.add(new ShooterTableEntry(Feet.of(19), 4.4 + 0.75, 1.0, Feet.of(0.0))); // 21.5 degrees       
        shooterTable.add(new ShooterTableEntry(Feet.of(20.5), 3.58 + 0.75, 1.0, Feet.of(0.0)));     
        shooterTable.add(new ShooterTableEntry(Feet.of(22), 3.1 + 0.75, 1.0, Feet.of(0.0))); // 20.5 degrees
        shooterTable.add(new ShooterTableEntry(Feet.of(24), 2.6 + 0.75, 1.0, Feet.of(0.0)));
        shooterTable.add(new ShooterTableEntry(Feet.of(27), 0.25 + 0.75, 0.98, Feet.of(0.0))); // 20 degrees
